-- Rollback da migration 20260723102000_future_transactions_l1_status_filters.sql
-- Restaura o comportamento ANTERIOR das funções (sem filtro por status).

-- -------------------------------------------------------------------------
-- 1) get_balances_by_currency (versão anterior)
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- 2) get_category_expenses_by_parent (versão anterior)
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- 3) get_month_expenses_total (versão anterior)
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- 4) get_month_income_total (versão anterior)
-- -------------------------------------------------------------------------
...
-- -------------------------------------------------------------------------
-- 5) get_budgets_with_usage (versão anterior)
-- -------------------------------------------------------------------------
